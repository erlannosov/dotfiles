...
-- theme & transparency 
-- --------------------
-- default, habamax, blue, darkblue, delek, desert, elflord, evening, industry, 
...
vim.opt.signcolumn = "no"		-- always show sign columns 
...
vim.opt.pumheight = 100			-- popup menu height
